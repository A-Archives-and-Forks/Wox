...
class WindowsSystemInput extends SystemInputInterface {
  static const MethodChannel _channel = MethodChannel('com.wox.windows_window_manager');

  static final WindowsSystemInput instance = WindowsSystemInput._();

  WindowsSystemInput._();
