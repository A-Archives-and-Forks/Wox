...
abstract class WoxSettingBaseView extends GetView<WoxSettingController> {
  ...
  Widget formField({required String label, required Widget child, String? tips, Widget? tipsWidget, double labelWidth = 160}) {
    final resolvedTips = tipsWidget ?? (tips == null ? null : Text(tips, style: TextStyle(color: getThemeSubTextColor(), fontSize: 13)));
